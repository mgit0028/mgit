...
​
  <div data-role="main" class="ui-content">
    <form method="post" action="jquerymd88888888.php">
...
<td>
 ...
 <fieldset data-role="controlgroup">
  ...
  <label for="red">31+2</label>
          <input type="checkbox" name="a['31']" id="red" value="31">
          <label for="green">32</label>
          <input type="checkbox" name="a['32']" id="green" value="32">
          <label for="blue">33</label>
          <input type="checkbox" name="a['33']" id="blue" value="33">  
 ...
 <fieldset data-role="controlgroup">
  ...
  <label for="red">34+2</label>
          <input type="checkbox" name="a['34']" id="red" value="34">
          <label for="green">35</label>
          <input type="checkbox" name="a['35']" id="green" value="35">
          <label for="blue">0</label>
          <input type="checkbox" name="a['0']" id="blue" value="0">  
 ...
 <fieldset data-role="controlgroup">
  ...
  <label for="red">b16</label>
          <input type="checkbox" name="b['b13']" id="red" value="b16">
